...
Fix a basis $\cB$ of $\R[x]_d$. Let $\cP = \{p_1,\dots,p_m\}$ and $\cQ = \{q_1, \dots, q_\ell\}$ be sets of polynomials with $S = \{\alpha \in \R^n | \forall p \in \cP: p(\alpha) = 0, \forall q \in \cQ: q(\alpha) \geq 0\}$. Assume $(\cP, \cQ, S)$ is $(\delta, k, \epsilon)$-nice up to degree $d$.  
